...
public:
    ...
    LocalDataInitializer(NumLib::LocalToGlobalIndexMap const& dof_table,
        ...
        : _dof_table(dof_table),
          other_shapefunction_order_(other_shapefunction_order)
    {
        if (shapefunction_order < 1 || 2 < shapefunction_order)
            OGS_FATAL("The given shape function order {:d} is not supported",
                      shapefunction_order);
        if (other_shapefunction_order < 1 || 2 < other_shapefunction_order)
            OGS_FATAL("The given shape function order {:d} is not supported",
...
// /// Quads and Hexahedra ///////////////////////////////////
    ...
    OGS_MAX_ELEMENT_DIM >= 2 && OGS_MAX_ELEMENT_ORDER >= 2
_builder[std::type_index(typeid(MeshLib::Quad8))] =
    makeLocalAssemblerBuilder<NumLib::ShapeQuad8>(other_shapefunction_order_);
_builder[std::type_index(typeid(MeshLib::Quad9))] =
    makeLocalAssemblerBuilder<NumLib::ShapeQuad9>(other_shapefunction_order_);
#endif

#if (OGS_ENABLED_ELEMENTS & ENABLED_ELEMENT_TYPE_CUBOID) != 0 && \
    OGS_MAX_ELEMENT_DIM >= 3 && OGS_MAX_ELEMENT_ORDER >= 2
_builder[std::type_index(typeid(MeshLib::Hex20))] =
    makeLocalAssemblerBuilder<NumLib::ShapeHex20>(other_shapefunction_order_);
#endif
...
// /// Simplices ////////////////////////////////////////////////
    ...
    OGS_MAX_ELEMENT_DIM >= 2 && OGS_MAX_ELEMENT_ORDER >= 2
_builder[std::type_index(typeid(MeshLib::Tri6))] =
    makeLocalAssemblerBuilder<NumLib::ShapeTri6>(other_shapefunction_order_);
#endif

#if (OGS_ENABLED_ELEMENTS & ENABLED_ELEMENT_TYPE_SIMPLEX) != 0 && \
    OGS_MAX_ELEMENT_DIM >= 3 && OGS_MAX_ELEMENT_ORDER >= 2
_builder[std::type_index(typeid(MeshLib::Tet10))] =
    makeLocalAssemblerBuilder<NumLib::ShapeTet10>(other_shapefunction_order_);
#endif
...
// /// Prisms ////////////////////////////////////////////////////
    ...
    OGS_MAX_ELEMENT_DIM >= 3 && OGS_MAX_ELEMENT_ORDER >= 2
_builder[std::type_index(typeid(MeshLib::Prism15))] =
    makeLocalAssemblerBuilder<NumLib::ShapePrism15>(other_shapefunction_order_);
#endif
...
// /// Pyramids //////////////////////////////////////////////////
    ...
    OGS_MAX_ELEMENT_DIM >= 3 && OGS_MAX_ELEMENT_ORDER >= 2
_builder[std::type_index(typeid(MeshLib::Pyramid13))] =
    makeLocalAssemblerBuilder<NumLib::ShapePyra13>(other_shapefunction_order_);
#endif
        }
    }
...
private:
    ...
    static LADataBuilder makeLocalAssemblerBuilder(
        const unsigned other_shapefunction_order = 1)
    {
    ...
    const unsigned other_shapefunction_order_;
...
private:
    ...
    template <typename ShapeFunction>
    static LADataBuilder makeLocalAssemblerBuilder(
        const unsigned other_shapefunction_order, std::true_type* /*unused*/)
    {
        if (ShapeFunction::ORDER == other_shapefunction_order)
        {
